 ...
 * 
 * 1. Make sure you are set to build for the Teensy LC!
...
// Set to true if you don't want to use touch sensing and need more
// pins to use for buttons (more than 13).
// If true, you can change the keys in the Touch Keys array (kTouchKeys)
// and 
...
// To modify the correct index, count over to the correct key in kButtonsKeys above count over to the same index here.
...
/*
 *  PART II. Touch Sensing (or extra buttons)
 */

/* If kUseTouchAsButtons is TRUE, then all the pins that are touch sensing capable will simply be used like button pins above. */
...
/* If kUseTouchAsButtons is FALSE, you can use touch sensing! */
